...
import 'package:andrewyip_dialogflowdemo/utils/responsive_widget.dart';
//import 'dart:js' as js;
import 'package:andrewyip_dialogflowdemo/utils/my_platform.dart';
  ...
  Widget buildHeaderLinks(BuildContext context) {
    if (!ResponsiveWidget.isSmallScreen(context)) {
      ...
      return PopupMenuButton(
        ...
        child: Image.asset("lib/assets/menu.png", width: 25, height: 25),
  ...
  String getTargetUrl(NavLinks link) {
    ...
    switch (link) {
      ...
      case NavLinks.Github:
        url = "https://github.com/andrewyip1";
        break;
